...
\item \textbf{The ITSEF} is the \emph{IT Security Evaluation Facility}. It is an evaluation laboratory, in possession of a certification body agreement, which performs the security tests to assess the resilience of the product
