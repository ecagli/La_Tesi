...
\begin{figure}
\caption{Linear, quadratic and cubic regression for a truly noised quadratic problem.}\label{fig:poly_reg}
\end{figure}

\begin{figure}
\caption{Cubic regression for a noised quadratic problem and more training examples.}\label{fig:cubic_more_data}
\end{figure}
...
Machine learning algorithms have started to be considered in SCA research in....
