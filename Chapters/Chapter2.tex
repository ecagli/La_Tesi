...
\subsection{Leakage Models}\label{sec:leakage_model}
...
\subsection{Simple vs Advanced SCAs}
...
\end{equation}
eventually the prior densities $p_{\vaLeakVec}(\vLeakVec)$, $p_{\sensRandVar}(\sensVar)$, and finally the \textit{a-posteriori} density, by means of the Bayes' theorem:
