...
\end{equation}   
where the vector $\vec{\sensVar_i}$ denotes the one-hot encoding of the realisation $\sensVar_i=\sensVarValue{j}$, \ie the vector $\sensVarOneHot{j} = (0,\ldots , 0,\underbrace{1}_{j},0,\dots,0)$ (as defined in Sec.~\ref{sec:notations}).
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{../tikz_per_manuscritto/convnet_arch.pdf}
