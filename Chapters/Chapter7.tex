...
\begin{figure}
\includegraphics[width=.5\textwidth]{figures/mu_comparison_new.pdf} 
\includegraphics[width=.5\textwidth]{figures/good_bad_coeffs.pdf} 
...
\begin{figure}
\centering
\includegraphics[width=.5\textwidth]{figures/2order_MULT.pdf}
