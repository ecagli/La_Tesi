...
\item[(2)] supprimer $R$ time samples, choisis de façon aléatoire uniforme.\\
\end{itemize}
...
\subsubsection{Performance Estimation}\label{sec:performances_NN}
\paragraph*{Maximal Accuracies and Confusion Matrix} 
