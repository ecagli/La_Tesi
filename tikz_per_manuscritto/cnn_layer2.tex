...
\draw[fill=blue!70,opacity=0.2,draw=blue,line width = 0.1mm]  (\decTer, 5 * \dimRec + 1 * \dimRec ) rectangle (\decTer + 1 * \dimRec,6*\dimRec+ 1 * \dimRec) node[pos=.5,white,opacity=1] {$\vOneOneOne$};
\draw[fill=blue!70,opacity=0.2,draw=blue,line width = 0.1mm]  (\decTer, 5 * \dimRec + 0 * \dimRec ) rectangle (\decTer + 1 * \dimRec,6*\dimRec+ 0 * \dimRec) node[pos=.5,white,opacity=1] {$\vOneTwoOne$};

\draw[fill=blue!70,opacity=0.2,draw=blue,line width = 0.1mm]  (\decTer + 1*\dimRec, 5 * \dimRec + 1 * \dimRec ) rectangle (\decTer + 2 * \dimRec,6*\dimRec+ 1 * \dimRec) node[pos=.5,white,opacity=1] {$\vOneOneTwo$};
\draw[fill=blue!70,opacity=0.2,draw=blue,line width = 0.1mm]  (\decTer + 1*\dimRec, 5 * \dimRec + 0 * \dimRec ) rectangle (\decTer + 2 * \dimRec,6*\dimRec+ 0 * \dimRec) node[pos=.5,white,opacity=1] {$\vOneTwoTwo$};

\draw[fill=blue!70,opacity=0.2,draw=blue,line width = 0.1mm]  (\decTer + 2*\dimRec, 5 * \dimRec + 1 * \dimRec ) rectangle (\decTer + 3 * \dimRec,6*\dimRec+ 1 * \dimRec) node[pos=.5,white,opacity=1] {$\vOneOneThree$};
\draw[fill=blue!70,opacity=0.2,draw=blue,line width = 0.1mm]  (\decTer + 2*\dimRec, 5 * \dimRec + 0 * \dimRec ) rectangle (\decTer + 3 * \dimRec,6*\dimRec+ 0 * \dimRec) node[pos=.5,white,opacity=1] {$\vOneTwoThree$};




\draw[fill=blue!70,opacity=0.4,draw=blue,line width = 0.1mm]  (\dimEpsilon + \decTer + 3*\dimRec, 5 * \dimRec + 1 * \dimRec ) rectangle (\dimEpsilon + \decTer + 4*\dimRec, 6*\dimRec+ 1 * \dimRec) node[pos=.5,white,opacity=1] {$\vTwoOneOne$};
\draw[fill=blue!70,opacity=0.4,draw=blue,line width = 0.1mm]  (\dimEpsilon + \decTer + 3*\dimRec, 5 * \dimRec + 0 * \dimRec ) rectangle (\dimEpsilon + \decTer + 4*\dimRec,6*\dimRec+ 0 * \dimRec) node[pos=.5,white,opacity=1] {$\vTwoTwoOne$};

\draw[fill=blue!70,opacity=0.4,draw=blue,line width = 0.1mm]  (\dimEpsilon + \decTer + 4*\dimRec, 5 * \dimRec + 1 * \dimRec ) rectangle (\dimEpsilon + \decTer + 5*\dimRec,6*\dimRec+ 1 * \dimRec) node[pos=.5,white,opacity=1] {$\vTwoOneTwo$};
\draw[fill=blue!70,opacity=0.4,draw=blue,line width = 0.1mm]  (\dimEpsilon + \decTer + 4*\dimRec, 5 * \dimRec + 0 * \dimRec ) rectangle (\dimEpsilon + \decTer + 5*\dimRec,6*\dimRec+ 0 * \dimRec) node[pos=.5,white,opacity=1] {$\vTwoTwoTwo$};

\draw[fill=blue!70,opacity=0.4,draw=blue,line width = 0.1mm]  (\dimEpsilon + \decTer + 5*\dimRec, 5 * \dimRec + 1 * \dimRec ) rectangle (\dimEpsilon + \decTer + 6*\dimRec,6*\dimRec+ 1 * \dimRec) node[pos=.5,white,opacity=1] {$\vTwoOneThree$};
\draw[fill=blue!70,opacity=0.4,draw=blue,line width = 0.1mm]  (\dimEpsilon + \decTer + 5*\dimRec, 5 * \dimRec + 0 * \dimRec ) rectangle (\dimEpsilon + \decTer + 6*\dimRec,6*\dimRec+ 0 * \dimRec) node[pos=.5,white,opacity=1] {$\vTwoTwoThree$};

\pgfmathsetmacro{\decQuad}{2*\dimEpsilon + \decTer + 6*\dimRec}


\draw[fill=blue!70,opacity=0.6,draw=blue,line width = 0.1mm]  (\decQuad, 5 * \dimRec + 1 * \dimRec ) rectangle (\decQuad + 1 * \dimRec,6*\dimRec+ 1 * \dimRec) node[pos=.5,white,opacity=1] {$\vOneOneOne$};
\draw[fill=blue!70,opacity=0.6,draw=blue,line width = 0.1mm]  (\decQuad, 5 * \dimRec + 0 * \dimRec ) rectangle (\decQuad + 1 * \dimRec,6*\dimRec+ 0 * \dimRec) node[pos=.5,white,opacity=1] {$\vOneTwoOne$};

\draw[fill=blue!70,opacity=0.6,draw=blue,line width = 0.1mm]  (\decQuad + 1*\dimRec, 5 * \dimRec + 1 * \dimRec ) rectangle (\decQuad + 2 * \dimRec,6*\dimRec+ 1 * \dimRec) node[pos=.5,white,opacity=1] {$\vOneOneTwo$};
\draw[fill=blue!70,opacity=0.6,draw=blue,line width = 0.1mm]  (\decQuad + 1*\dimRec, 5 * \dimRec + 0 * \dimRec ) rectangle (\decQuad + 2 * \dimRec,6*\dimRec+ 0 * \dimRec) node[pos=.5,white,opacity=1] {$\vOneTwoTwo$};

\draw[fill=blue!70,opacity=0.6,draw=blue,line width = 0.1mm]  (\decQuad + 2*\dimRec, 5 * \dimRec + 1 * \dimRec ) rectangle (\decQuad + 3 * \dimRec,6*\dimRec+ 1 * \dimRec) node[pos=.5,white,opacity=1] {$\vOneOneThree$};
\draw[fill=blue!70,opacity=0.6,draw=blue,line width = 0.1mm]  (\decQuad + 2*\dimRec, 5 * \dimRec + 0 * \dimRec ) rectangle (\decQuad + 3 * \dimRec,6*\dimRec+ 0 * \dimRec) node[pos=.5,white,opacity=1] {$\vOneTwoThree$};




\draw[fill=blue!70,opacity=0.6,draw=blue,line width = 0.1mm]  (\dimEpsilon + \decQuad + 3*\dimRec, 5 * \dimRec + 1 * \dimRec ) rectangle (\dimEpsilon + \decQuad + 4*\dimRec, 6*\dimRec+ 1 * \dimRec) node[pos=.5,white,opacity=1] {$\vTwoOneOne$};
\draw[fill=blue!70,opacity=0.6,draw=blue,line width = 0.1mm]  (\dimEpsilon + \decQuad + 3*\dimRec, 5 * \dimRec + 0 * \dimRec ) rectangle (\dimEpsilon + \decQuad + 4*\dimRec,6*\dimRec+ 0 * \dimRec) node[pos=.5,white,opacity=1] {$\vTwoTwoOne$};

\draw[fill=blue!70,opacity=0.6,draw=blue,line width = 0.1mm]  (\dimEpsilon + \decQuad + 4*\dimRec, 5 * \dimRec + 1 * \dimRec ) rectangle (\dimEpsilon + \decQuad + 5*\dimRec,6*\dimRec+ 1 * \dimRec) node[pos=.5,white,opacity=1] {$\vTwoOneTwo$};
\draw[fill=blue!70,opacity=0.6,draw=blue,line width = 0.1mm]  (\dimEpsilon + \decQuad + 4*\dimRec, 5 * \dimRec + 0 * \dimRec ) rectangle (\dimEpsilon + \decQuad + 5*\dimRec,6*\dimRec+ 0 * \dimRec) node[pos=.5,white,opacity=1] {$\vTwoTwoTwo$};

\draw[fill=blue!70,opacity=0.6,draw=blue,line width = 0.1mm]  (\dimEpsilon + \decQuad + 5*\dimRec, 5 * \dimRec + 1 * \dimRec ) rectangle (\dimEpsilon + \decQuad + 6*\dimRec,6*\dimRec+ 1 * \dimRec) node[pos=.5,white,opacity=1] {$\vTwoOneThree$};
\draw[fill=blue!70,opacity=0.6,draw=blue,line width = 0.1mm]  (\dimEpsilon + \decQuad + 5*\dimRec, 5 * \dimRec + 0 * \dimRec ) rectangle (\dimEpsilon + \decQuad + 6*\dimRec,6*\dimRec+ 0 * \dimRec) node[pos=.5,white,opacity=1] {$\vTwoTwoThree$};
