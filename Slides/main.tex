...
\tikzstyle{cipher} = [rectangle, draw, text width=6em, text centered, rounded corners, minimum height=8em]
\tikzstyle{data} = [rectangle, draw, text width=6em, text centered, minimum height=3em, fill=green!30]
