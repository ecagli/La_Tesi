...
\tikzstyle{cipher} = [rectangle, draw, text width=5em, text centered, rounded corners, minimum height=9em]
...
\date{05/12/2018, Paris - 31/01/2019, Grenoble}
...
\begin{frame}[plain]
	...
	\hfill \includegraphics[height=0.85cm]{../Figures/LOGO_SU.jpg} \hspace*{15pt} \includegraphics[height=0.85cm]{../Figures/LOGO_LIP6.png} 
		\centering
  		\titlepage
  		CESTI - Centre d'\'Evaluation de la S\'ecurit\'e des Technologies de l'Information - CEA Grenoble\\
  		\vspace*{10pt}
...
\hfill \footnotesize{(ANSSI)}\\
\hfill \small{\emph{CEA Supervisor :} C\'ecile Dumas\textcolor{white}{}} \\
\hfill \footnotesize{(CESTI - CEA Grenoble)}
\end{column}
\end{columns}
