...
\tikzstyle{data} = [rectangle, draw, text width=4em, text centered, minimum height=3em, fill=green!30]
\tikzstyle{function} = [ellipse, draw, text width=4em, text centered, minimum height=1.5em, fill=violet!30]
\tikzstyle{methods} = [rectangle, rounded corners, draw, text width=4em, text centered, minimum width=7em, fill=blue!30]
