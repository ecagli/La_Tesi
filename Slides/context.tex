...
\only<1>{\includegraphics[width=.9\textwidth]{figures/simple_attack/Diapositive3.PNG} }
\only<2>{\includegraphics[width=.9\textwidth]{figures/simple_attack/Diapositive2.PNG} }
\only<3->{\includegraphics[width=.9\textwidth]{figures/simple_attack/Diapositive1.PNG} }
...
\only<8>{\includegraphics[width=\textwidth]{figures/advanced_attack/Diapositive8.PNG} }
...
\includegraphics[width=\textwidth]{Figures/trace_classifier/Slide1.png} 
\end{block}
}
\only<4>{
\begin{block}{Advanced Attack as a Classification Problem}
\includegraphics[width=\textwidth]{Figures/trace_classifier/Slide2.png} 
\end{block}
}
\only<5>{
\begin{block}{Advanced Attack as Multiple Classification Problems}
\includegraphics[width=\textwidth]{Figures/trace_classifier/Slide3.png} 
\end{block}
}
}
\end{frame}
