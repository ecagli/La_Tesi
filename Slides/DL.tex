...
\only<1>{
\includegraphics[width=\textwidth]{Figures/SNR_firstSbox.pdf}
}
\only<2>{
\includegraphics[width=\textwidth]{Figures/SNR_desynchro.pdf}
}
...
\end{scriptsize}
\uncover<2>{
\includegraphics[width=0.75\textwidth]{Figures/SNR_resynchro.pdf} 
}
\vspace*{-18pt}
