...
\vspace*{-5pt}
\uncover<5>{\hfill{Machine Learning classifiers in Side-Channel literature:\\ SVM (\textcolor{cyan}{\cite{machineLearningSCA,intelligentMachineOmicide}), RF (\cite{lerman2014power,lerman2015machine})}}}
