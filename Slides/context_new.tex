...
\item Sensitive applications
\item Pervasive aspect
%\item Hard to update
...
\only<2>{\includegraphics[width=\textwidth]{figures/Presentazione1/Slide2.PNG}}
\only<3>{\includegraphics[width=\textwidth]{figures/Presentazione1/Slide1.PNG}}
\end{column}
\end{columns}
\uncover<2->{$\Rightarrow$ Requires protection against very high-level attacker}
%
%\begin{block}{}
%\begin{itemize}
...
\emph{Differential Power Analysis} \textcolor{cyan}{\cite{kocher1999differential}}\\
\emph{Correlation Power Analysis} \textcolor{cyan}{\cite{brier2004correlation}}\\
\emph{Mutual Information Analysis} \textcolor{cyan}{\cite{gierlichs2008mutual,batina2011mutual}}...
 \end{textblock}
 }
  \only<9>{\begin{textblock}{5}(1,10)
\emph{Non-profiling attacks\\
Profiling attacks}
 \end{textblock}
 }
\end{frame}
...
Task - Performance - Experience \textcolor{cyan}{\cite{Mitchell1997}}}
...
\vspace*{-5pt}
\uncover<3>{\hfill{Machine Learning classifiers in Side-Channel literature:\\ SVM (\textcolor{cyan}{\cite{machineLearningSCA,intelligentMachineOmicide}}), RF (\textcolor{cyan}{\cite{lerman2014power,lerman2015machine}})}}
\begin{block}{Classification problem}
Assign to a datum $\vaLeakVec$ a label $\sensRandVar$ among a set of possible labels $\mathcal{Z}=\{s_1,s_2,s_3\}$, or probabilities. 
\includegraphics[width=\textwidth]{figures/trace_classifier/Diapositive4.PNG} 
