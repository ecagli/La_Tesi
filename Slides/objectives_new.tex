...
\item \only<1>{SNR}\only<2>{\textcolor{red}{SNR}} \cite{mangard2008power}/ NICV \cite{bhasin2014side}
...
\item \only<1>{Linear Discriminant Analysis (LDA)}\only<2>{\textcolor{red}{Linear Discriminant Analysis (LDA)}} \cite{Standaert2008,lessIsMore}
