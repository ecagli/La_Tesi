...
\item \only<1-3>{\textcolor{grey}{$\pdf_{\given{\sensRandVar}{\vaLeakVec=\vLeakVec}}$ (discriminative model)}}\only<4->{\textcolor{black}{$\pdf_{\given{\sensRandVar}{\vaLeakVec=\vLeakVec}}$ (discriminative model)}}
\end{itemize}
\end{itemize}
%
...
\item \only<1>{convolutional layers to manage desynchronisation (a form of hiding)}\only<2->{\textcolor{red}{convolutional layers to manage desyncrhonisation (a form of hiding)}}
