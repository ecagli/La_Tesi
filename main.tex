...
\newcommand*{\nbAttackTraces}{N_a}
\newcommand*{\nbTracesPerClass}[1][\sensVar]{N_{#1}}
...
\newcommand*{\noise}{B}
\newcommand*{\Noise}{\textbf{B}}
\newcommand*{\extract}{\epsilon}
\newcommand*{\orderRate}{o}
\newcommand*{\guessingVector}{\textbf{g}}
...
\newcommand*{\mmmXclass}[1][z]{\overline{\textbf{x}}_{#1}}
\newcommand*{\mmmY}{\overline{\textbf{y}}}
\newcommand*{\varXclass}[1][z]{\hat{\boldsymbol{\sigma}}^2_{#1}}
...
\newcommand{\nununu}{\boldsymbol{\nu}}
\newcommand{\mmmXPhi}{\overline{\Phi(\textbf{x}})}
\newcommand{\mmmXclassPhi}[1][z]{\overline{\Phi(\textbf{x})}^{#1}}
...
\i%nclude{Chapters/Chapter9}
\include{Chapters/Chapter10}
\include{Chapters/Chapter11}
%\include{Chapters/ChapterExample_instructions}
%----------------------------------------------------------------------------------------
...
\include{Appendices/PCA_geometrical}
